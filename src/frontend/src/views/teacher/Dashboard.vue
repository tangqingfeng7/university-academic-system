<template>
  <div class="teacher-dashboard">
      ...
      <div class="action-grid">
        <div class="action-card" @click="goTo('/teacher/courses')">
          ...
          <div class="action-content">
            ...
            <div class="action-desc">查看授课课程</div>
          </div>
        ...
        <div class="action-card" @click="goTo('/teacher/attendance')">
          <div class="action-icon">
            <el-icon :size="28"><Clock /></el-icon>
          </div>
          <div class="action-content">
            <div class="action-title">考勤管理</div>
            <div class="action-desc">记录学生考勤</div>
          </div>
          <div class="action-arrow">
            <el-icon><ArrowRight /></el-icon>
          </div>
        ...
        <div class="action-card" @click="goTo('/teacher/exams')">
          <div class="action-icon">
            <el-icon :size="28"><EditPen /></el-icon>
          </div>
          <div class="action-content">
            <div class="action-title">考试管理</div>
            <div class="action-desc">管理课程考试</div>
          </div>
          <div class="action-arrow">
            <el-icon><ArrowRight /></el-icon>
          </div>
        ...
        <div class="action-card" @click="goTo('/teacher/evaluations')">
          <div class="action-icon">
            <el-icon :size="28"><Star /></el-icon>
          </div>
          <div class="action-content">
            <div class="action-title">课程评价</div>
            <div class="action-desc">查看学生评价</div>
          </div>
          <div class="action-arrow">
            <el-icon><ArrowRight /></el-icon>
          </div>
        ...
        <div class="action-card" @click="goTo('/teacher/students')">
          <div class="action-icon">
            <el-icon :size="28"><User /></el-icon>
          </div>
          <div class="action-content">
            <div class="action-title">学生管理</div>
            <div class="action-desc">查看选课学生</div>
          </div>
          <div class="action-arrow">
            <el-icon><ArrowRight /></el-icon>
          </div>
    ...
    <!-- 日历视图 -->
    <div class="calendar-section animate-fade-in-up" style="animation-delay: 0.3s;">
      <h2 class="section-title">教学日程</h2>
...
const loadCalendarEvents = async () => {
  try {
    const response = await fetch('/api/teacher/dashboard/calendar-events', {
      headers: {
