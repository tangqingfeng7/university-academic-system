  ...
  <div class="exam-list-page">
    ...
    >
      ...
      <div class="stat-card">
        ...
        <div class="stat-value stat-success">{{ inProgressCount }}</div>
      </div>
      <div class="stat-card">
    ...
    <div class="exam-table-container animate-fade-in-up" style="animation-delay: 0.3s;">
      ...
      >
        ...
        <el-table-column prop="location" label="考试地点" width="150" show-overflow-tooltip>
          <template #default="{ row }">
...
const upcomingCount = computed(() => {
  return examList.value.filter(exam => exam.status === 'PUBLISHED').length
})

const inProgressCount = computed(() => {
  return examList.value.filter(exam => exam.status === 'IN_PROGRESS').length
})
