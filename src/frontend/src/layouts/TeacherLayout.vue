      ...
      <el-aside :width="isCollapse ? '80px' : '240px'" class="apple-sidebar">
        <div class="sidebar-header">
          <div class="logo-wrapper" :class="{ collapsed: isCollapse }">
            <div class="logo-icon teacher-theme">
        ...
        <el-scrollbar class="sidebar-scroll">
          ...
          >
            ...
            <el-menu-item index="/teacher/exams/courses">
              ...
              <template #title>课程考试</template>
            </el-menu-item>

            <el-menu-item index="/teacher/exams/invigilation">
          ...
          <div class="header-content">
            ...
            <div class="header-right">
              ...
              <el-dropdown class="user-dropdown" @command="handleCommand">
                <div class="user-info">
                  <el-avatar :size="32" class="user-avatar teacher-avatar">
                    <el-icon :size="18"><User /></el-icon>
                  </el-avatar>
                  <span class="user-name">{{ userStore.userInfo?.name || userStore.userInfo?.username || '教师' }}</span>
                </div>
                <template #dropdown>
                  <el-dropdown-menu>
